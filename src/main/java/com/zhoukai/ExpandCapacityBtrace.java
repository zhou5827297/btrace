...
public class ExpandCapacityBtrace {
    ...
    public static void traceMapExpandCapacity(@ProbeClassName String probeClass, @ProbeMethodName String probeMethod,
        ...
        String point = BTraceUtils.Strings.strcat(BTraceUtils.Strings.strcat(probeClass, "."), probeMethod);//java/util/HashMap.resize
        ...
        println(BTraceUtils.Strings.strcat("table.length:", str(table.length)));
        println(BTraceUtils.Strings.strcat("size:", str(size)));
        println(BTraceUtils.Strings.strcat("threshold:", str(threshold)));
        println(BTraceUtils.Strings.strcat(point, "------------"));
    }
}